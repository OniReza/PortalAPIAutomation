...
public class Portals {
    ...
    public static class dev {
        ...
        public String xrpaynetmembers() {
            String url = "dev.xrpaynetmembers.com/";
            return url;
        }

        public String lifestylesevenmembers() {
            String url = "dev.lifestylesevenmembers.com";
            return url;
        }

        public String apaxCardservice()
        {
            String url="dev.apexcardmembers.com";
            return url;
        }

        public String novemgoldmembers() {
            String url = "dev.novemgoldmembers.com";
            return url;
        }

        public String shidomembers() {
            String url = "dev.shidomembers.com";
            return url;
        }
        ...
        public String aurixclubmembers(){
            String url="dev.aurixclubmembers.com";
            return url;
        }

        public String ultimamembers(){
            String url="dev.ultimamembers.com";
            return url;
        }

        public String globalmamembers(){
            String url="dev.globalcardmembers.com";
            return url;
        }


        public String seacretmembers(){
            String url="dev.seacretmembers.com/";
            return url;
        }
        public String uigiscmembers(){
            String url="dev.uigiscmembers.com/";
            return url;
        }
    ...
    public static class tst {
        ...
        public String wbpay(){
            String url="sandbox.wbtransfermembers.com";
            return url;
        }

            public String shidomembers(){
            String url="sandbox.shidomembers.com";
            return url;
        }
        ...
        public String ultimamembers(){
            String url="sandbox.ultimamembers.com";
            return url;
        }

        public String uigiscmembers(){
            String url="sandbox.uigiscmembers.com";
            return url;
        }

        public String aurixclubmembers(){
            String url="sandbox.aurixclubmembers.com";
            return url;
        }
        ...
        public String lifestylesevenmembers() {
            String url = "sandbox.lifestylesevenmembers.com";
            return url;
        }
